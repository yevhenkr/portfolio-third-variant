...
const SvgComponent = (props: SVGProps<SVGSVGElement>) => (
    <svg width="621" height="1019" viewBox="0 0 621 1019" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <defs>
            <linearGradient id="paint0_linear_15_2063" x1="621.653" y1="107.235" x2="562.831" y2="160.098"
                            gradientUnits="userSpaceOnUse">
                <stop stop-color="#13B0F5"/>
                <stop offset="1" stop-color="#CA24B4"/>
            </linearGradient>
            <linearGradient id="paint1_linear_15_2063" x1="527.723" y1="183.954" x2="427.611" y2="316.567"
                            gradientUnits="userSpaceOnUse">
                <stop stop-color="#E70FAA"/>
                <stop offset="1" stop-color="#13B0F5"/>
            </linearGradient>
            <linearGradient id="paint2_linear_15_2063" x1="603.265" y1="275.875" x2="550.402" y2="217.053"
                            gradientUnits="userSpaceOnUse">
                <stop stop-color="#13B0F5"/>
                <stop offset="1" stop-color="#CA24B4"/>
            </linearGradient>
            <linearGradient id="paint3_linear_15_2063" x1="246.778" y1="374.349" x2="325.208" y2="303.866"
                            gradientUnits="userSpaceOnUse">
                <stop stop-color="#00C0FD"/>
                <stop offset="0.421875" stop-color="#E70FAA"/>
                <stop offset="1" stop-color="#00C0FD"/>
            </linearGradient>
            <linearGradient id="paint4_linear_15_2063" x1="235.013" y1="669.876" x2="134.428" y2="594.956"
                            gradientUnits="userSpaceOnUse">
                <stop stop-color="#8E34FF"/>
                <stop offset="0.494792" stop-color="#CA24B4"/>
                <stop offset="1" stop-color="#8E34FF"/>
            </linearGradient>
            <linearGradient id="paint5_linear_15_2063" x1="392.585" y1="577.866" x2="465.959" y2="479.806"
                            gradientUnits="userSpaceOnUse">
                <stop stop-color="#13B0F5"/>
                <stop offset="0.75" stop-color="#CA24B4"/>
                <stop offset="1" stop-color="#13B0F5"/>
            </linearGradient>
            <linearGradient id="paint6_linear_15_2063" x1="529.413" y1="813.068" x2="428.829" y2="738.149"
                            gradientUnits="userSpaceOnUse">
                <stop stop-color="#13B0F5"/>
                <stop offset="0.0582928" stop-color="#CA24B4"/>
                <stop offset="1" stop-color="#13B0F5"/>
            </linearGradient>
        </defs>
    </svg>
...
export const AbstractSVG = memo(SvgComponent)
